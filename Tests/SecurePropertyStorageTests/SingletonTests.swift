...
extension Storages {
    static let singletonTagStorage: DelegatedStorage = SingletonStorage(authenticationTag: Data())
}
var singletonTagStorage: DelegatedStorage {
    Storages.singletonTagStorage
}
